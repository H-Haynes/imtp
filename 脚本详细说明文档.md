...
| 类别     | 脚本数量 | 主要功能                         |
| -------- | -------- | -------------------------------- |
| 核心开发 | 3        | 项目分析、开发工具、包创建       |
| 环境管理 | 4        | 环境变量检查、验证、创建         |
| 类型生成 | 3        | TypeScript、API、GraphQL类型生成 |
| 构建测试 | 6        | 构建、测试、清理、格式化         |
| 代码质量 | 3        | Lint、类型检查、预提交           |
| 监控备份 | 2        | 性能监控、备份回滚               |
| 工具脚本 | 4        | 最小化构建、验证等               |
...
### 3. `generate:graphql` - GraphQL类型生成器
